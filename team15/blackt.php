...
<head>
  ...
  <title>SF Black t-shirt - SF Products</title>
...
<div class="row">
<div class="col">
  <div class="box"> <img id="myImg" src="img/blackt.png" alt="Black t-shirt"> </div>
</div>
									<!-- The Modal -->
...
$query = "SELECT * FROM product WHERE proid = 'p24'";
// Execute the query
...
<div class="col box textContainer">
  ...
  <form name="myform" method="post" role="form">
    <div class="form-group"> 
      ...
      <p>SF signature black t-shirt </p>
    </div>
	  	  	  	  	  	  	  	  	  			  <div>
