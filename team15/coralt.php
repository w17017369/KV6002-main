...
<head>
  ...
  <title>Coral t-shirt - SF Products</title>
...
<div class="row">
<div class="col">
  <div class="box"> <img id="myImg" src="img/coraltee.png" alt="Coral t-shirt"> </div>
</div>
									<!-- The Modal -->
...
$query = "SELECT * FROM product WHERE proid = 'p18'";
// Execute the query
