  ...
  <body>
    ...
    try {
      ...
      if (isset($_SESSION[ 'user_id'])) {
        ...
        //If fav_id is empty display error message
        if (empty($fav_id)) {
          ...
          //Create sql query to delete favourites record for selected product
          $deleteSQL = "DELETE 
                FROM favourites
                WHERE favid = $fav_id";
          ...
          if ( isset( $_SERVER[ 'HTTP_REFERER' ] ) ) {
            ...
            //If not then store favourites.php
            $referer = "favourites.php";
          }

          //Check if sql was successful to display correct message
        ...
        //If user_id does not exist display error message
