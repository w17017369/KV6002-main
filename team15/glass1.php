...
<head>
  ...
  <title>Regular wine glass - SF Products</title>
...
<div class="row">
<div class="col">
  <div class="box"> <img id="myImg" src="img/glass1.png" alt="Regular wine glass"> </div>
</div>
								<!-- The Modal -->
...
$query = "SELECT * FROM product WHERE proid = 'p11'";
// Execute the query
