...
<head>
  ...
  <title>Large wine glass - SF Products</title>
...
<div class="row">
<div class="col">
  <div class="box"> <img ID="myImg" src="img/glass2.png" alt="Large glass"> </div>
</div>
									<!-- The Modal -->
...
$query = "SELECT * FROM product WHERE proid = 'p12'";
// Execute the query
