...
<head>
  ...
  <title>Green t-shirt - SF Products</title>
...
<div class="row">
<div class="col">
  <div class="box"> <img id="myImg" src="img/greentee.png" alt="Green t-shirt"> </div>
</div>
									<!-- The Modal -->
...
$query = "SELECT * FROM product WHERE proid = 'p19'";
// Execute the query
