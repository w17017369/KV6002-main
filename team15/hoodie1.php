...
<head>
  ...
  <title>Cream hoodie - SF Products</title>
...
<div class="row">
<div class="col">
  <div class="box"> <img id="myImg" src="img/creamhoodie.png" alt="Cream hoodie"> </div>
</div>	
									<!-- The Modal -->
...
$query = "SELECT * FROM product WHERE proid = 'p13'";
// Execute the query
