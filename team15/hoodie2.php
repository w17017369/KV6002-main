...
<head>
  ...
  <title>Green hoodie - SF Products</title>
...
<div class="row">
<div class="col">
  <div class="box"> <img id="myImg" src="img/greenhoodie.png" alt="Green hoodie"> </div>
</div>
									<!-- The Modal -->
...
$query = "SELECT * FROM product WHERE proid = 'p14'";
// Execute the query
