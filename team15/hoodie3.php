...
<head>
  ...
  <title>Grey hoodie - SF Products</title>
...
<div class="row">
<div class="col">
  <div class="box"> <img id="myImg" src="img/greyhoodie.png" alt="Grey hoodie"> </div>
</div>
									<!-- The Modal -->
...
$query = "SELECT * FROM product WHERE proid = 'p15'";
// Execute the query
