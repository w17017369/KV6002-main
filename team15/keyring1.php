...
<head>
  ...
  <title>Quote keyring - SF Products</title>
...
<div class="row">
<div class="col">
  <div class="box"> <img id="myImg" src="img/keyholder1.png" alt="Quote keyring"> </div>
</div>
...
$query = "SELECT * FROM product WHERE proid = 'p3'";
// Execute the query
...
<div class="col box textContainer">
  ...
  <form name="myform" method="post" role="form">
    <div class="form-group"> 
      ...
      <p>A silver lightweight keyring with a quote on.  </p>
    </div>
	  			  <div>
