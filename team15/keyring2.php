...
<head>
  ...
  <title>Quote keyring 2- SF Products</title>
...
<div class="row">
<div class="col">
  <div class="box"> <img id="myImg" src="img/keyholder2.png" alt="Quote keyring 2"> </div>
</div>
...
$query = "SELECT * FROM product WHERE proid = 'p4'";
// Execute the query
