...
<head>
  ...
  <title>Blank keyring - SF Products</title>
...
<div class="row">
<div class="col">
  <div class="box"> <img id="myImg" src="img/keyholder3.png" alt="Blank keyring"> </div>
</div>
...
$query = "SELECT * FROM product WHERE proid = 'p5'";
// Execute the query
...
<div class="col box textContainer">
  ...
  <form name="myform" method="post" role="form">
    <div class="form-group"> 
      ...
      <p>A silver lightweight blank keyring  </p>
    </div>
	  	  			  <div>
