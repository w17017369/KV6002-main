...
<head>
  ...
  <title>SF special mug - SF Products</title>
...
<div class="row">
<div class="col">
  <div class="box"> <img id="myImg" src="img/mug1.png" alt="SF special mug"> </div>
</div>
...
$query = "SELECT * FROM product WHERE proid = 'p6'";
// Execute the query
...
<div class="col box textContainer">
  ...
  <form name="myform" method="post" role="form">
    <div class="form-group"> 
      ...
      <p>A white mug with a funny quote on. </p>
    </div>
	  	  	  			  <div>
