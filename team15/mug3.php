...
<head>
  ...
  <title>SF Plain mug - SF Products</title>
...
<div class="row">
<div class="col">
  <div class="box"> <img id="myImg" src="img/mug3.png" alt="SF plain mug"> </div>
</div>
						<!-- The Modal -->
...
$query = "SELECT * FROM product WHERE proid = 'p8'";
// Execute the query
