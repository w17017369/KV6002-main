...
<head>
  ...
  <title>Peach phone case - SF Products</title>
...
<div class="row">
<div class="col">
  <div class="box"> <img id="myImg" src="img/peachcase.png" alt="Peach phone case"> </div>
</div>	
							<!-- The Modal -->
...
$query = "SELECT * FROM product WHERE proid = 'p10'";
// Execute the query
