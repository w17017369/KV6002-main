...
<head>
  ...
  <title>Pink SF signature cap - SF Products</title>
...
<div class="row">
<div class="col">
  <div class="box"> <img id="myImg" src="img/pinkcap.png" alt="SF pink cap"> </div>
</div>
...
$query = "SELECT * FROM product WHERE proid = 'p2'";
// Execute the query
...
<div class="col box textContainer">
  ...
  <form name="myform" method="post" role="form">
    <div class="form-group"> 
      ...
      <p>A simple pink cap with the SF signature on. </p>
    </div>
	  			  <div>
