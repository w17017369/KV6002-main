...
<head>
  ...
  <title>Plain t-shirt - SF Products</title>
...
<div class="row">
<div class="col">
  <div class="box"> <img id="myImg" src="img/blanktee.png" alt="Blank t-shirt"> </div>
</div>
									<!-- The Modal -->
...
$query = "SELECT * FROM product WHERE proid = 'p16'";
// Execute the query
