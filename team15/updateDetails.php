    ...
    <?php
      try {
        ...
        if (isset($_SESSION[ 'user_id'])) {
          ...
          //Query database fpr user details
          $selectSQL = "SELECT *
                FROM dsf_users
          ...
          //Display dashboard and populated form
            ...
            <div class='row display-table-row'>
              ...
              <div class='col-md-10 col-sm-11 display-table-cell v-align'>  
                <div class='user-dashboard'>
                  ...
                  <div class='row'>
                    <form class='update-details-form' action='updateDetailsProcess.php' method='post'> 
                      <label class='update-details-label' for='firstname'>First name:</label>
                      <input class='update-details-input' type='text' class='form-control' name='firstname' value='{$rowObj->firstname}' pattern='[a-zA-Z]+' title='Only alphabets are allowed.' size='20' minlenght='1' maxlength='20' accesskey='f'  tabindex='1' required />
                      <label class='update-details-label' for='surname'>Last name:</label>
                      <input class='update-details-input' type='text' class='form-control' name='surname' value='{$rowObj->surname}' pattern='[a-zA-Z]+' title='Only alphabets are allowed.' size='20' minlenght='1' maxlength='20' accesskey='l' tabindex='2' required />
                      <label class='update-details-label' for='email'>Email:</label>
                      <input class='update-details-input' type='text' class='form-control' name='email' value='{$rowObj->email}' size='20' accesskey='e' tabindex='3' required />
                      <label class='update-details-label' for='phone'>Phone:</label>
                      <input class='update-details-input' type='text' class='form-control' name='phone' value='{$rowObj->phone}'  size='11' minlenght='11' maxlength='11' accesskey='p' tabindex='4' required />              
