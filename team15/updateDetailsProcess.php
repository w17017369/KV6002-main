  ...
  <body>
    ...
    try {
      if (isset($_SESSION['user_id'])) {
        ...
        //To remove whitespace from beginning and end of the string
        ...
        //Check if book title is too long
        if (strlen($phone) > 11) {
        ...
        if ($error == false) {
          try {
            ...
            //update database records with prepared statement
            ...
            //Store book details in variable and sanitise data to prevent XXS
