...
<head>
  ...
  <title>SF White t-shirt - SF Products</title>
...
<div class="row">
<div class="col">
  <div class="box"> <img id="myImg" src="img/whitet.png" alt="White t-shirt"> </div>
</div>
									<!-- The Modal -->
...
$query = "SELECT * FROM product WHERE proid = 'p23'";
// Execute the query
...
<div class="col box textContainer">
  ...
  <form name="myform" method="post" role="form">
    <div class="form-group"> 
      ...
      <p>SF signature white t-shirt </p>
    </div>
	  	  	  	  	  	  	  	  	  			  <div>
